  ...
  <body>
    <div class="container">
        <div class="d-flex justify-content-between m-2">
            <a class="btn btn-primary show" href="{{url('AdminPosts/create')}}" id='addbtn'>Add Post</a>
        ...
        <main class="post blog-post col-lg-8">
          <div class="container">
            <div class="control show delete" >
                <form action="{{ route('AdminPosts.destroy',$item->id) }}" method="Post" style="display: inline-block">
                    @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger" >Delete</button>
                </form>
                <a href="{{url('AdminPosts/'.$item->id.'/edit')}}" class="btn btn-primary">Edit</a>
            </div>
            <div class="post-single">
              <div class="post-thumbnail"><img src="img/Post/{{$item->first_image}}" alt="..." class="img-fluid"></div>
              <div class="post-details">
                ...
                <div class="post-body">
                  ...
                  <p> <img src="img/Post/{{$item->second_image}}" alt="..." class="img-fluid"></p>
                ...
                <div class="post-comments">
                  ...
                  <div class="comment">
                    ...
                    <div class="comment-body">
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio obcaecati ad, ducimus dignissimos atque consequatur quas fuga nemo illo eveniet voluptate qui exercitationem earum perferendis! Labore iure magni architecto quas.</p>
                    </div>
                  </div>
                  <div class="comment">
                    <div class="comment-header d-flex justify-content-between">
